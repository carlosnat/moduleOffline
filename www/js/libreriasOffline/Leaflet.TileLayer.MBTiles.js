...
L.TileLayer.MBTiles = L.TileLayer.extend({
	...
	initialize: function initialize(databaseUrl, options) {
		var _this = this;
	...
	funcion_one: function(req){
		return dump(req.responseText);
	},
	funcion_two: function(){

	},
	_openDB: function _openDB(buffer) {
		try {
